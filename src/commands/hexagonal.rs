...
pub fn generate(project_name: String, version: String, author: String, about: String) {
    ...
    let tera = Tera::new(concat!(env!("CARGO_MANIFEST_DIR"), "/src/templates/hexagonal/**/*"))
...
"#)
    ...
    println!("Project {} generated successfully with hexagonal architecture", project_name);
}
